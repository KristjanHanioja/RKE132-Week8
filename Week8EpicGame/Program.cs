...
string folderPath = @"C:\Users\krist\OneDrive\töölaud\data\";
...
//string[] weapon = { "excalibur", "magic wand", "frying pan", "banana", "Lego brick" };
//string[] heroes = { "Geralt of Rivia", "Dragonborn", "Harry Potter", "Frodo", "Thor"};
//string[] villains = { "The Wild Hunt", "Alduin", "Voldemort", "Sauron", "Loki"};
